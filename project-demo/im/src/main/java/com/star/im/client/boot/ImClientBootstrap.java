...
import com.star.im.client.handler.ClientHandler;
...
public class ImClientBootstrap {
	...
	private static ClientHandler buildClientHandlerFromCommandLineArgs(String[] args) {
		return new ClientHandler(args[0], args[1]);
	}
