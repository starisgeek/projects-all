...
public class BalanceChangeRecordDaoTest extends BaseDaoTest {
	@Autowired
	private BalanceChangeRecordDao recordDao;
	...
	public void testInsertChangeRecord() {
		AccountChangeRecord changeRecord = AccountChangeRecord.newBuilder()
				.serialNumber(generator.generate()).accountId(123).changeAmount(123)
